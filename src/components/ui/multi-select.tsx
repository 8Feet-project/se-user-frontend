...
interface MultiSelectProps
	...
	/**
	 * Controlled selected values. When provided, the component stays in sync with parent state.
	 */
	value?: string[];
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
	(
		...
		}, [arraysEqual, isControlled, selectedValues, value]);
				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"theme-multiselect-trigger flex min-h-12 h-auto items-center justify-between rounded-2xl border border-[rgba(99,202,183,0.2)] bg-[#07111f] p-1 text-slate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.02)] hover:bg-[#07111f] [&_svg]:pointer-events-auto",
							...
							{selectedValues.length > 0 ? (
								<div className="flex justify-between items-center w-full">
									...
									<div className="flex items-center justify-between">
										...
										/>
										<ChevronDown
											className="h-4 mx-2 cursor-pointer text-slate-500"
											aria-hidden="true"
										/>
									</div>
								</div>
								...
								<div className="flex items-center justify-between w-full mx-auto">
									<span className="text-sm text-slate-500 mx-3">
										{placeholder}
									</span>
					...
					<PopoverContent
						...
						className={cn(
							"theme-multiselect-panel w-auto p-0",
